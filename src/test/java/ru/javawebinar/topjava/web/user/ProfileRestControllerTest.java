...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void createDuplicateMail() throws Exception {
        UserTo newTo = new UserTo(null, "badName", "admin@gmail.com", "badPassword", DEFAULT_CALORIES_PER_DAY);
    ...
    void updateDuplicateMail() throws Exception {
        UserTo updatedTo = new UserTo(null, "badName", "admin@gmail.com", "badPassword", DEFAULT_CALORIES_PER_DAY);
        perform(MockMvcRequestBuilders.put(REST_URL)
                .with(userHttpBasic(user))
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(updatedTo)))
